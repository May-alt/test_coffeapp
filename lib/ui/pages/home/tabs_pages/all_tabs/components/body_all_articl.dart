...
class BodyAllArtical extends StatefulWidget {
  const BodyAllArtical({Key? key}) : super(key: key);

  @override
  State<BodyAllArtical> createState() => _BodyAllArticalState();
}

class _BodyAllArticalState extends State<BodyAllArtical> {
  @override
